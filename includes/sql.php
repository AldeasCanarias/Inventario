...
/*--------------------------------------------------------------*/
 ...
 function updateLastLogIn($user_id)
  ...
  function join_product_table(){
     global $db;
     /*$sql  =" SELECT p.id,p.name,p.quantity,p.buy_price,p.sale_price,p.media_id,p.date,p.code,s.state_id,l.location_id,";
    $sql  .=" c.name AS categorie,m.file_name AS image, s.state_name AS state_name, l.location_name AS location_name";
    $sql  .=" FROM products p";
